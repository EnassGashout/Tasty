...
<body class="boxed_wrapper">
    ...
    <section class="page-title centred">
        <div class="container">
            <div class="text">Posts for Resturant Category</div>
        </div>
    </section>
    <!--End Page Title-->
    <!-- blog-side -->
    <section class="blog-side blog-style-one Resturant-section">
        <div class="container">
            <div class="row">
                              ...
                              foreach($results as $result) {
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="content-box overlay-item">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><img src="images\Resturant\<?php echo $result['blogIMG']; ?>" alt=""></figure>
                                                <div class="overlay-box">
                                                    <div class="overlay-inner">
                                                        <div class="content">
